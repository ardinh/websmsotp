...
if (substr($json[PAYLOAD_MSISDN], 0, 3) !== "628" && substr($json[PAYLOAD_MSISDN], 0, 4) !== "3636") {
...
finish: if (isset($stmt) && $stmt !== false) {
    $stmt->close();
}
...
function sendlog($i, $e, $er, $b, $p)
{
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_HTTPHEADER => array(
            ...
            "Postman-Token: e749f14d-f71d-4d7a-84ac-5343dfa4aef4,46e3d255-fe28-4436-87e3-d3a81f82f17a",
