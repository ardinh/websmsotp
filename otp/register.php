...
<?php
session_start();
//echo "select * from user where username='".$_POST['username']."' and password='".md5($_POST['password'])."'";
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
                <div class="well no-padding" style="top: auto">
                    <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post" id="login-form" class="smart-form client-form">
                        ...
                        <fieldset>
                            No credit card required. Already have an account? <a href="login.php">Log in.</a>

                            <section>
                                <label class="label">First Name</label>
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    <input type="text" name="f_name">
                                    <b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Please enter your first name</b></label>
                            </section>
                            <section>
                                <label class="label">Last Name</label>
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    <input type="text" name="l_name">
                                    <b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Please enter your last name</b></label>
                            </section>
